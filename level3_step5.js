$(document).ready(function() {
    ...
    while (randomBlocks.length < 16) {
        ...
        if (!randomBlocks.some(block => block.x === randX && block.y === randY)) {
            ...
            if(macaroonAbilityActive){
                ...
                if (randomBlocks.length < 8) {
                    initialHitValue = 3;
                } else if (randomBlocks.length < 16) {
                    initialHitValue = 2;
                }
            }
    ...
    function handleBlockHit(block, c, r) {
        ...
        if (block.remainingHits <= 0) {
            ...
            if (block.isClear && gameClear === false) {
                ...
                createPopup("level3_step6.html", "17.png");//수정 발생
                //삭제 수정 발생
            }
    ...
    function gameOver() {
        ...
        createPopup('level3.html', 'gameover.png');
    }
